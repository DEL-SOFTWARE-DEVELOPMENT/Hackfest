...
exports.register = async(req,res,next) => {
    try {
        ...
        const successRes = await UserServices.registerUser(email,password, name, address);
...
exports.login = async (req, res, next) => {
    try {
        ...
        let tokenData = {_id:user._id,email:user.email,name:user.name,address:user.address};
